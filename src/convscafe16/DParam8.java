...
public class DParam8
{
  ...
  void dprm8() throws IOException, BiffException { Workbook workbook = Workbook.getWorkbook(new File(FXMLDocumentController.rt));
    ...
    String dat = "C:\\data\\" + fe + FXMLDocumentController.condominio + "copia8.csv";
      ...
      for ( fila = 1; fila < sheet.getRows(); fila++)
      {
        ...
        alert.setTitle("Error");
                ...
                alert.setContentText("Error: \n"
                                   ...
                                   + "Revisar el data y remplazar la comilla, no se insertaran los registros completos "
                                   );
                alert.showAndWait();
    ...
    String  cr, aux2;
        aux2 = sheet.getCell(crfc, fila).getContents();
        ...
        String ae = sheet.getCell(Subtotal, fila).getContents();
        System.out.print(ae + " |");
        ...
        String ib = sheet.getCell(IVA, fila).getContents();
        ...
        System.out.print(j2 + " |");
        double sumas = Float.parseFloat(j2);
        salida.write(";");
        salida.write(j2);
...
alert.setTitle("Error1");
        ...
        alert.setContentText("Errores probables1: \n"
                ...
                + "no se cuenta con el software dbf comander\n"
  ...
  // Runtime.getRuntime().exec("cmd /c start "+dat);
